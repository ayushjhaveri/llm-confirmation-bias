...
def main():
    ...
    ap.add_argument(
        ...
        type=str,
        default=None,
        help="Path to a Trainer checkpoint dir (e.g. outdir/checkpoint-3200). "
            "If set, training will resume from this checkpoint."
    )
    ...
    if args.resume_from_checkpoint:
        print(f"[RESUME] Resuming from checkpoint: {args.resume_from_checkpoint}", flush=True)
    else:
        print("[RESUME] Starting training from scratch.", flush=True)
