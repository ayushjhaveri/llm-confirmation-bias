    ...
    def __init__(
        ...
        if retry_cfg is None:
            retry_cfg = RetryConfig(
                ...
                per_attempt_timeout_s=float(os.getenv("LLM_PER_ATTEMPT_TIMEOUT_S", os.getenv("PORTKEY_TIMEOUT_S", "60"))),
                total_deadline_s=float(os.getenv("LLM_TOTAL_DEADLINE_S", os.getenv("PORTKEY_DEADLINE_S", "240"))),
