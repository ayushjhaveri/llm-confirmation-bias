"""
vLLM-based wrapper for local Llama 3.3 70B Instruct.
- Hardcoded decoding defaults (no params accepted/passed through)
...
class Llama33_70B:
    def __init__(
        ...
        max_model_len: int = 8192,     # cap context to 8K
        ...
        # Hardcoded decoding defaults (not overridable from outside)
        ...
        # Llama Instruct is not a thinking model emitting <think> blocks
    ...
    # NO params argument, NO cfg inspection
...
# Keep the dataclass around only if other code imports it; it is NOT used to control decoding.
@dataclass
class GenParams:
